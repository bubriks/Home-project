...
public class Report extends JFrame {
	...
	private void Write(File newTextFile) throws Exception{
			...
			fw.write("\nOwner- Sintija Zaņģe 040972-11072,Kurzemes iela 29, Tukums ,AS SEB Unibanka,UNLALV2X,LV95UNLA0050009677801,40003151743.");//2
			...
			fw.write("\nZigrīda,0.0,0.0,71.0,57.0,4.0,0.0.");//8
			fw.write("\nEgnārs,0.0,0.0,42.68,28.5,0.0,7.0.");//9
	        fw.close();
	}
