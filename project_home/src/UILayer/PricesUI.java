...
class PricesUI extends JFrame {
	...
	JPanel contentPane;
	JTextField electricityStartField, waterStartField, electricityEndField, waterEndField;//todo maybe remove
	...
	PricesUI(){
		...
		electricityStartField.setText(""+InfoController.info.prices.getElectricity());
		...
		waterStartField.setText(""+InfoController.info.prices.getWater());
